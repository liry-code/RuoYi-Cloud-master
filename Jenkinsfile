...
//                 -pl curry-a -am -amd -Pdev -Dmaven.test.skip=true
...
//                 sh 'echo ------ datasource complete --------------'
                ...
                sh 'mvn clean install -pl ruoyi-common-swagger -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ swagger complete --------------'
                sh 'mvn clean install  -pl ruoyi-common-core -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ core complete --------------'
                sh 'mvn clean install -pl ruoyi-api-system -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ system complete --------------'
                sh 'mvn clean install -pl ruoyi-common-redis -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ redis complete --------------'
                sh 'mvn clean install -pl ruoyi-common-security -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ security complete --------------'
                sh 'mvn clean install -pl ruoyi-common-log -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ log complete --------------'
                sh 'mvn clean install -pl ruoyi-common-datascope -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ datascope complete --------------'
                sh 'mvn clean install -pl ruoyi-common-datasource -am -amd -Pdev -Dmaven.test.skip=true'
                sh 'echo ------ datasource complete --------------'
            }
        }
